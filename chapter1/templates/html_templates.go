...
func HTMLDifferences() error {
	...
	// html/template auto-escapes unsafe operations like javascript injection this is contextually aware and
	// will behave differently depending on where a variable is rendered
