...
func WorkWithBuffer() error {
	...
	b := Buffer(rawString)
	// we can quickly convert a buffer back into byes with b.Bytes() or a string with b.String()
	...
	// we can also take our bytes and create a bytes reader these readers implement io.Reader, io.ReaderAt,
