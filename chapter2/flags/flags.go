...
// Config will be the holder for our s
type Config struct {
	subject      string
	isAwesome    bool
	howAwesome   int
...
func (c *Config) Setup() {
	...
	flag.StringVar(&c.subject, "subject", "", "subject is a string it defauls to empty")
	flag.StringVar(&c.subject, "s", "", "subject is a string it defauls to empty (shorthand)")
	...
	flag.Var(&c.countTheWays, "c", "coma separated list of integer")
}
